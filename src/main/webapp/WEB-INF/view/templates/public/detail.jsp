    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
          <div class="ml-auto">
			<a href="${pageContext.request.contextPath}/user/logout" class="btn btn-primary border-width-2 d-none d-lg-inline-block" <c:if test="${not empty sessionScope.username}">style="display: block"</c:if>>Log Out</a>
          </div>
            		...
            		<th>
		                <li class="comment">
		                  ...
		                  <div class="comment-body">
		                    <h3>${user.name}</h3>
		                    <div class="meta" style="color: #373b3e !important;">${user.createdDate}</div>
		                    <p>${user.money}</p>
		                  </div>
		                </li>
		            </th>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form:form modelAttribute="userDonation" action="${pageContext.request.contextPath}/user/add-user-donation" method="post">
